...
Similar graphs to the ones in section \ref{sec:relations_clubs} were created for politicians. Figure ... shows this graphs for the legislative periods ... The closer two politicians appear together in a graph, the more positive is their relation. The politician nodes are in the color of the parliamentary club, the politician belongs to in the legislative period. The edges are colored in the color of the parliamentary club, if both nodes belong to the same club.
