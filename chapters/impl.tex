...
The relation graphs\footnote{See section \ref{sec:pol_relation_graph} and \ref{sec:club_relation_graph} for the creation of the graphs} were visualized with force layout graphs of the d3 JavaScript library. As Bostock \cite{d3_2011} describes in his paper about d3, the force layout is built with the an algorithm proposed by Dwyer \cite{Dwyer_2009}.
